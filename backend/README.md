...
## Project Structure
    ...
    ├── test_install_moduel_44309  # Django project configurations
...
1. Clone this repo and `cd test_install_moduel_44309`
...
2. Clone this repo and `cd test_install_moduel_44309`
